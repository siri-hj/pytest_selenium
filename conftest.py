...
from selenium_pytest.config.conf import cm
from selenium_pytest.common.readconfig import ini
from selenium_pytest.utils.times import timestamp
from selenium_pytest.utils.send_mail import send_report
...
def pytest_html_results_summary(prefix, summary, postfix):
    ...
    prefix.extend([html.p("所属部门: 超级科技有限公司测试部")])
    prefix.extend([html.p("测试执行人: 大黄")])
